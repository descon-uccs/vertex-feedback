...
\end{abstract}
\begin{altabstract}
Nous d\'erivons un majorant sur la cardinalit\'e d'une coupe-cycles de sommets de taille minimum pour des graphes orient\'es, et fournissons des exemples de graphes qui atteignent cette majorant.
\end{altabstract}
