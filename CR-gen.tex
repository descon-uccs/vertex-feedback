...
\end{minipage}\endgroup
  \ifnum\CorrA=\z@\else{{\def\@thefnmark{\rule{0pt}{10pt}$*\,$}%
    \@footnotetext{\def\CDRss{\ifnum\CorrA>\@ne\relax s\fi}\if@francais
      Auteur\CDRss\ correspondant\CDRss\else Corresponding
      author\CDRss\fi. \CDRextrafirstfootnotetext}}}\fi
}%
\def\@setafterauthor{%
  \vglue3mm%
%  \hspace*{0pt}%
